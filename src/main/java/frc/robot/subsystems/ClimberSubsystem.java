...
falconMotorL.config_kF(0, 0.0475, 30);
falconMotorL.config_kP(0, 0.047, 30);
falconMotorL.config_kI(0, 0.0, 30);
falconMotorL.config_kD(0, 0.0, 30);
...
>>>>>>> 6071e81e5e5ff658c96a85cc3f9d81964ea001ec
  ...
  public void goTo(double positionTarget) {
    falconMotorR.configFactoryDefault();
    falconMotorL.configFactoryDefault();
    falconMotorR.set(0.0);
    falconMotorL.set(0.0);
    ...
    */
    ...
    falconMotorL.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true, 50, 55, 1.0));
    falconMotorR.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true, 50, 55, 1.0));
    falconMotorL.set(ControlMode.Position, positionTarget);
 }
